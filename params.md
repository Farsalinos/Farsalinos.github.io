...
defaultBackgroundImage = "images/v3/site-background.svg" # used as default for background images
backgroundCanvas = true # render defaultBackgroundImage as a fixed backdrop on every page
defaultFeaturedImage = "/img/featured.svg" # used as default for featured images in all articles
...
[homepage]
  layout = "profile" # valid options: page, profile, hero, card, background, landing, custom
  # layoutSwitcher = true # opt-in interactive preview of the built-in layouts
  # homepageImage = "/img/iceland.jpg" # used in: hero, and card
  showRecent = true
  showRecentItems = 6
  showMoreLink = true
  showMoreLinkDest = "categories"
  cardView = true
...
[list]
  showHero = false
  # featureImageHover = false # subtle zoom on card thumbnails on hover
  heroStyle = "background" # valid options: basic, big, background, thumbAndBackground
