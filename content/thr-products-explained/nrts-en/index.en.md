...
Unlike electronic cigarettes, which rely on vaporization, NRT comes in several pharmaceutical forms suited to different dependence levels. These fall into two categories:
...
The basic principle of NRT is decoupling nicotine from the toxic substances produced by combustion. While nicotine is the addictive component, it's the tar, ash, and carbon monoxide in cigarette smoke that cause the vast majority of smoking-related diseases.
...
NRT appears on the World Health Organization's (WHO) Model List of Essential Medicines. Clinical research confirms that using NRT increases successful quitting rates by 50% to 70% compared to unassisted attempts.
