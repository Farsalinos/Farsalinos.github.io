...
- **Electronic Control:** Regulates the power delivered to the coil.

- **Atomizer:** The battery provides current to a coil covered in liquid. The liquid heats up, turning it into an aerosol (a more accurate term than "vapor").

- **The Result:** The process occurs at temperatures much lower than those of combustion (**180°C-250°C**), eliminating the production of tar, ash, and carbon monoxide.
...
- **Reduced Toxicity:** Emissions of toxic substances are overwhelmingly lower, as solid carbon particles and polycyclic aromatic hydrocarbons (PAHs) are absent.

- **Biomarkers:** Clinical studies show that smokers who switched to vaping exhibit rapid improvement in cardiovascular function markers and a reduction in toxin exposure of up to 90%.
...
- **Speed:** It achieves maximum nicotine concentration in the blood in approximately **5-10 minutes**, offering immediate satisfaction.

- **Sensation-Behavior:** It simulates the "hand-to-mouth" motion and the "**throat hit**," elements that are crucial for maintaining abstinence from smoking, unlike pharmaceutical substitutes (gums, patches).
...
This strategy recognizes that many smokers find it difficult to quit nicotine entirely. By providing them with an alternative that eliminates combustion, the risk of serious diseases is drastically reduced. The main scientific limitation remains the need for long-term epidemiological data; however, the current scientific consensus is that switching to vaping represents a choice with exponentially fewer risks.
